...
function convertEventHandler([onEventName, callback]: [
  ...
  // If the property seems legit, create a proper event handler object
  // @todo: implement this!
...
function parseProps(props: Properties): {
  ...
  // Extract event handlers from props and create and the correct object.
  // @todo: implement this!
  const eventHandlers = [];
...
function renderElement(element: JSXFlatElement): Node | null {
  ...
  if (typeof element.type === "string") {
    ...
    // For each event handler, assign the correct handler to the correct
    // node for the correct event
    // @todo: implement this!
